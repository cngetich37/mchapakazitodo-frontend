    ...
    <>
      <div class="bg-gray-500 h-screen w-screen flex items-center">
        <div class="h-max mx-auto flex flex-col items-center">
          ...
          <h1 class="text-3xl font-bold font-mono monospace text-white text-center italic pb-4">
          ...
          <div class="bg-white shadow-xl p-10 flex flex-col gap-4 text-sm">
            <div>
              ...
              <input
                class="border border-purple-600 focus:outline-slate-400 rounded-md w-full shadow-sm px-5 py-2"
                type="email"
                name="email"
            ...
            <div class="flex">
              <div class="w-1/2">
                ...
                <label class="font-mono monospace text-blue-900" for="rememberMe">Remember me</label>
              </div>
              <div class="w-1/2">
